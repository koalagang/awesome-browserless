...
* YouTube: [youtube-dl](https://github.com/ytdl-org/youtube-dl) *or* [youtube-viewer](https://github.com/trizen/youtube-viewer) *or* [pipe-viewer](https://github.com/trizen/pipe-viewer) *or* [FreeTube](https://github.com/FreeTubeApp/FreeTube)  *or* [NewPipe](https://github.com/TeamNewPipe/NewPipe) (an Android app) *or* [SkyTube](https://skytube-app.com/) (another Android app) *or* [yt](https://github.com/sayan01/scripts/blob/master/yt) *or* [Ytfzf](https://github.com/pystardust/ytfzf) (has thumbnail support using Ueberzug) *or* [Streamlink](https://github.com/streamlink/streamlink) (see below NOTE section) *or* [MusicPiped](https://github.com/deep-gaurav/MusicPiped) (Android music app) *or* [HoloPlay](https://github.com/stephane-r/HoloPlay) (another Android music app) *or* [Olivia](https://github.com/keshavbhatt/olivia) (Linux music app) - *TIP*: when using pipe-viewer, you can use [Invidious](https://github.com/iv-org/invidious) instead of YouTube by parsing the `--invidious` flag. You can also use FreeTube with Invidious. *Another TIP*: when using Ytfzf, if you want to use the J and K keys (vim keys) instead of the up and down keys, simply hold down ctrl while pressing J or K
